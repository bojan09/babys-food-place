...
const SearchRecipes = () => {
  ...
  return (
    <div className="flex justify-center items-center bg-color_lightgray rounded-full w-30vw">
      ...
      <button
        className="xs:py-[4px] md:py-[6px] xs:px-[.7rem] md:px-[2rem] flex items-center gap-2 text-gray-800 bg-color_orange rounded-full p-4 text-xl font-semibold hover:bg-orange-500"
        onClick={() => {}}
      >
        Search
        <img
